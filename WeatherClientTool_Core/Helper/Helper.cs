...
namespace WeatherClientTool_Core.Helper
{
    public class Helper
    {
        ...
        public static string WeatherCodeInterpretation(int weatherCode, Logger _logger)
        {
            switch (weatherCode)
            {
                case 0:
        ...
        public static string TakeInput(Logger _logger)
        {
        ...
        public static string GetChoice(Logger _logger)
        {
        ...
        public static bool GetWeatherDetails(string cityName, Logger _logger)
        {
            City city = null;
            ...
            else
            {
                ...
                Console.WriteLine("\nWeather Code: " + city.WeatherCode + " - " + WeatherCodeInterpretation(city.WeatherCode, _logger));
            }
