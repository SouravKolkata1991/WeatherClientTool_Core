...
namespace WeatherClientTool_Core.DAL
{
        ...
        public City GetWeatherDetails(City _city)
        {
            ...
            try
            {
                ...
                if (uri.IsCompleted)
                {
                    ...
                    _city.Temperature = (decimal)apiResponse.current_Weather.temperature;
                    _city.Windspeed = (decimal)apiResponse.current_Weather.windspeed;
                    _city.WindDirection = (decimal)apiResponse.current_Weather.winddirection;
                    _city.WeatherCode = (int)apiResponse.current_Weather.weathercode;
                    _city.Status = true;
